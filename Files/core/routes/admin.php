...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        ...
        //Commission
        Route::get('commissions/deposit', 'commissionsDeposit')->name('commissions.deposit');
        Route::get('commissions/buy', 'commissionsBuy')->name('commissions.buy');
        Route::get('commissions/win', 'commissionsWin')->name('commissions.win');
